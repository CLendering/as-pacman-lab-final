...
class DefensiveAStarAgent(ParticleFilterAgent):
    def __init__(
        ...
        self.OPPONENT_GHOST_WEIGHT_ATTENUATION = 2 # Attenuation factor for the cost based on distance to the opponent ghost
        self.OPPONENT_PACMAN_WEIGHT = 8  # Reward for approaching an opponent pacman
        self.OPPONENT_PACMAN_WEIGHT_ATTENUATION = 1  # Attenuation factor for the reward based on distance to the opponent pacman
        self.ALLY_GHOST_WEIGHT = 8  # Cost for approaching an ally ghost
        self.ALLY_GHOST_WEIGHT_ATTENUATION = 2 # Attenuation factor for the cost based on distance to the ally ghost
        self.ALLY_PACMAN_WEIGHT = 1  # Cost for approaching an ally pacman
        self.ALLY_PACMAN_WEIGHT_ATTENUATION = 1  # Attenuation factor for the cost based on distance to the ally pacman
